...
def test__default_octoai_api_base() -> None:
    chat = ChatOctoAI(octoai_api_token="test_token")  # type: ignore[call-arg]
...
def test__field_aliases() -> None:
    chat = ChatOctoAI(octoai_api_token="test_token", model="custom-model")  # type: ignore[call-arg]
