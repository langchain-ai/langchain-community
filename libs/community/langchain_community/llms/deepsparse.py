    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        if self.streaming:
            ...
            text = (
                self.pipeline(sequences=prompt, **(self.generation_config if isinstance(self.generation_config, dict) else {}))
                .generations[0]
                .text
            )
    ...
    def _stream(
        ...
        **kwargs: Any,
        ...
        inference = self.pipeline(
            sequences=prompt, streaming=True, **(self.generation_config if isinstance(self.generation_config, dict) else {})
        )
