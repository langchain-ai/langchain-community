...
def cosine_similarity_top_k(
    ...
    top_k = min(top_k or len(score_array), np.count_nonzero(score_array))  # type: ignore[assignment]
    top_k_idxs = np.argpartition(score_array, -top_k, axis=None)[-top_k:]  # type: ignore[operator]
