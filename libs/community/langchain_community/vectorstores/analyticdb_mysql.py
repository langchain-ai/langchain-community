...
class AnalyticDBMySQLSettings(BaseSettings):
    ...
    def get_env_config() -> AnalyticDBMySQLSettings:
        ...
        config.password = os.getenv("ADB_PASSWORD")
...
class AnalyticDBMySQL(VectorStore):
    ...
    def similarity_search(
        ...
        Args:
            ...
            where_str: where condition string. Defaults to None.
    ...
    def delete(self, ids: list[str] | None = None, **kwargs: Any) -> bool | None:
        if ids:
            ...
            self._execute_sql(
                ...
                f"WHERE {self.config.column_map['id']} IN ({ids_str})",
            )
        else:
            self._execute_sql(
