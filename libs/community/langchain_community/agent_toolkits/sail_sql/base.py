...
from langchain_community.agent_toolkits.sail_sql.prompt import SQL_PREFIX, SQL_SUFFIX
from langchain_community.agent_toolkits.sail_sql.toolkit import SailSQLToolkit

if TYPE_CHECKING:
    from langchain_classic.agents.agent import AgentExecutor


def create_sail_sql_agent(
    llm: BaseLanguageModel,
    toolkit: SailSQLToolkit,
    ...
    **kwargs: Any,
    ...
    """Construct a Sail SQL agent from an LLM and tools.

    !!! warning
        This agent can execute arbitrary SQL against your Sail environment.
        ...
        ``create_sail_sql_agent`` returns a ``langchain_classic`` ``AgentExecutor``.
